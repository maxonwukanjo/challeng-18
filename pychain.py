...
input_data_sender = st.text_input("sender")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
input_data_receiver = st.text_input("receiver")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
input_data_amount = st.text_input("amount")
...
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        record=Record(sender=input_data_sender, receiver=input_data_receiver, amount=input_data_amount),
        creator_id=12,
